<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="astarea_update.aspx.cs" Inherits="mid.astarea_update" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="panel panel-default col-lg-12" dir="rtl">
        <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">تعديل المناطق والمدن</h2>
        </div>
    </div>
