...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
  ...
  <tbody>
    <tr>
      ...
      <td>
         ...
         <td>
          <asp:TextBox ID="txt_DateEN" runat="server" OnTextChanged="txt_DateEN_TextChanged"  AutoPostBack="true" AutoCompleteType="Disabled"></asp:TextBox>
    ...
    <tr>
      ...
      <td>
         ...
         <td>
          <asp:DropDownList ID="ddl_customer" runat="server" OnSelectedIndexChanged="ddl_customer_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
      </td>
         <td>
            ...
            <div class="col-md-12">
                <table class="table table-bordered table-responsive">
                    ...
                    <tr class="first_row">
                        ...
                        <td>
                            <asp:TextBox ID="txt_sell_price" runat="server" width="40px" OnTextChanged="txt_sell_price_TextChanged" AutoPostBack="true" placeholder="00.0"></asp:TextBox>
                        ...
                        <td>
                            <asp:TextBox ID="txt_sell_discount" runat="server" width="40px"  placeholder="%" OnTextChanged="txt_sell_discount_TextChanged" AutoPostBack="true"></asp:TextBox>
                        ...
                        <td>
                            <asp:TextBox ID="txt_tax" runat="server" width="40px" placeholder="%" OnTextChanged="txt_tax_TextChanged" AutoPostBack="true"></asp:TextBox>
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btn_save_total" runat="server" Text="إضافة" OnClick="btn_save_total_Click" />
                        </td>
                    </tr>
                </table>
            </div>
  ...
  <tbody>
    ...
    <!--start button-->
    <div class="save">
                    <asp:Button ID="btn_save" runat="server" Text="حفظ"  Class="btn btn-success" OnClick="btn_save_Click"/>
                     <asp:Button ID="btn_cancel" runat="server" Text="تراجع" class="btn btn-danger"  OnClick="btn_cancel_click"/>
    </div>
