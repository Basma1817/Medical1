<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="add_astarea.aspx.cs" Inherits="mid.add_astarea" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div class="panel panel-default col-lg-12" dir="rtl">
        <div class="panel-body">
            <h2 class="panel-title" style="font-size: 29px;">اضافة مناطق ومدن</h2>
        </div>
    </div>
